...
const About = () => {
  return (
    <>
      <div className=' text-8xl font-semibold relative'>
        <span
        ...
        <span
          className='bg-gradient-to-r text-2xl from-cyan-500 py-4 pt-6 to-teal-500 text-transparent bg-clip-text relative z-10'
          id='more-about'
        >
          <br />
          <TypeAnimation
  sequence={[
    "Looks like u aa Interested About Me ! ",
    1000, 
    "Looks like u aa Interested About Me !! ",
    400, 
    "Looks like u aa Interested About Me !!! ",
