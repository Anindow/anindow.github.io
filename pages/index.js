              ...
              <div className="h-96 w-96 hidden sm:block">
                <Canvas className="ml-16 -mt-40">
                  ...
                  <Sphere args={[1, 100, 200]} scale={2.52}>
                    <MeshDistortMaterial color={"#00897B"} distort={0.5} speed={2} />
                  </Sphere>
                </Canvas>
              </div>
        ...
        <section className="py-10">
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              ...
              Bootstrap, and{" "}
              <span className="text-teal-500">Tailwind CSS</span>. With a solid
              foundation in front-end development, I have a keen eye for detail
              and a passion for crafting visually appealing and user-friendly
              websites. My expertise extends to back-end technologies, allowing
              me to build robust server-side functionalities and APIs using
              Node.js. I am committed to staying updated with the latest trends
              and best practices in web development, ensuring that my projects
              are at the forefront of innovation. With excellent problem-solving
